...
{
    public static readonly string ResourceName = "FasTnT.Host.Tests.Features.v2_0.Communication.Resources.Requests.Request_ObjectEvent_WithMultipleMasterdata.json";
