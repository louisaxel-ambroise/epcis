...
{
    public static readonly string ResourceName = "FasTnT.Host.Tests.Features.v1_2.Communication.Resources.Events.AggregationEvent_Full.xml";
    ...
    {
        var expectedDate = new DateTime(2013, 06, 08, 14, 58, 56, 591);
