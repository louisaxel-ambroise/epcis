...
{
    public static readonly string ResourceName = "FasTnT.Tests.Features.v2_0.Communication.Resources.Events.ObjectEvent_StringCertificationInfoArrayInvalid.json";
