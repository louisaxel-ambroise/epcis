        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestId = table.Column<int>(type: "INTEGER", nullable: false),
                    MasterDataIndex = table.Column<int>(type: "INTEGER", nullable: false),
                    Id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasterDataRequestId = table.Column<int>(type: "INTEGER", maxLength: 256, nullable: false),
                    MasterDataIndex = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
...
FROM [MasterData] md 
WHERE RequestId = (SELECT MAX(RequestId) FROM [MasterData] other WHERE other.Type = md.Type AND other.Id = md.Id);");
...
AS (
	...
	JOIN [CurrentMasterdata] cur ON cur.[RequestId] = children.[MasterDataRequestId] AND cur.[Index] = [MasterDataIndex]
