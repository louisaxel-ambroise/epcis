...
public class SqlServerModelConfiguration : IModelConfiguration
{
    const string Epcis = nameof(Epcis);
    const string Sbdh = nameof(Sbdh);
    const string Cbv = nameof(Cbv);
    const string Subscription = nameof(Subscription);
    ...
    public void Apply(ModelBuilder modelBuilder)
    {
        ...
        mdProperty.ToView(nameof(MasterDataProperty), Cbv);
        mdProperty.HasNoKey();
        ...
        subscription.ToTable(nameof(Subscription), Subscription, builder => builder.HasTrigger("SubscriptionInitialRequests"));
        ...
        {
            c.ToTable(nameof(SubscriptionSchedule), Subscription);
        ...
        {
            c.ToTable(nameof(SubscriptionParameter), Subscription);
        ...
        {
            c.ToTable(nameof(SubscriptionExecutionRecord), Subscription);
            c.Property<int>("SubscriptionId");
        ...
        pendingRequests.ToTable(nameof(PendingRequest), Subscription);
        ...
        {
            c.ToTable(nameof(StoredQueryParameter), Subscription);
